...
export default function ResortCard({ resort }) {
  const { img, place_name, reviews_amount, location, ownerExclusive, _id, resort_ID } = resort;
  ...
  // Seed for deterministic fallback
  const seed = _id || resort_ID || cleanedPlaceName;
